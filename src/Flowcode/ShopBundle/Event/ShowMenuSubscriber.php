    ...
    public function handler(ShowMenuEvent $event)
    {
        ...
        $menuOptions[] = array(
            ...
            "submenu" => array(
                ...
                array(
                    "url" => $this->router->generate('admin_orderstatus'),
                ...
                array(
                    "url" => $this->router->generate('admin_strategy'),
                    "title" => $this->translator->trans('strategy'),
                ),
                array(
                ...
                array(
                    "url" => $this->router->generate('admin_productitemfield'),
                    "title" => $this->translator->trans('Item Field'),
                ),
            ),
        );
